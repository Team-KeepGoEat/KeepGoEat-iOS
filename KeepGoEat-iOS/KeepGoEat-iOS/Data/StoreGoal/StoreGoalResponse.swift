...
let getStoreGoalDataList: [GetStoreGoalResponse] = [
    ...
    GetStoreGoalResponse(goals: [
        ...
        StoreGoal(goalID: 2, goalContent: "물", isMore: true, isOngoing: false, writerID: 1, totalCount: 16, startedAt: "2022. 12. 01", keptAt: "2022. 12. 31", isAchieved: false),
        StoreGoal(goalID: 2, goalContent: "아침", isMore: true, isOngoing: false, writerID: 1, totalCount: 16, startedAt: "2022. 12. 01", keptAt: "2022. 12. 31", isAchieved: false),
        StoreGoal(goalID: 2, goalContent: "저녁 두 숟갈", isMore: false, isOngoing: false, writerID: 1, totalCount: 16, startedAt: "2022. 12. 01", keptAt: "2022. 12. 31", isAchieved: false)
    ], goalCount: 5)
]
